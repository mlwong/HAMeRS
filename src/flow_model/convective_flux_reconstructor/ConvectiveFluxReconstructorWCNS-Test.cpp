 ...
 */
boost::shared_ptr<tbox::Timer> ConvectiveFluxReconstructorWCNS_Test::t_compute_v_p_f;
boost::shared_ptr<tbox::Timer> ConvectiveFluxReconstructorWCNS_Test::t_compute_theta_omega;
boost::shared_ptr<tbox::Timer> ConvectiveFluxReconstructorWCNS_Test::t_compute_projection_matrices;
boost::shared_ptr<tbox::Timer> ConvectiveFluxReconstructorWCNS_Test::t_compute_midpoint_fluxes;
boost::shared_ptr<tbox::Timer> ConvectiveFluxReconstructorWCNS_Test::t_compute_fluxes;
boost::shared_ptr<tbox::Timer> ConvectiveFluxReconstructorWCNS_Test::t_miscellaneous;
boost::shared_ptr<tbox::Timer> ConvectiveFluxReconstructorWCNS_Test::t_allocate_memory;

boost::shared_ptr<tbox::Timer> ConvectiveFluxReconstructorWCNS_Test::t_projection;
boost::shared_ptr<tbox::Timer> ConvectiveFluxReconstructorWCNS_Test::t_WENO_interpolation;
boost::shared_ptr<tbox::Timer> ConvectiveFluxReconstructorWCNS_Test::t_Riemann_solver;

boost::shared_ptr<tbox::Timer> ConvectiveFluxReconstructorWCNS_Test::t_WENO_interpolation_compute_sigma_TV;
boost::shared_ptr<tbox::Timer> ConvectiveFluxReconstructorWCNS_Test::t_WENO_interpolation_compute_beta;
boost::shared_ptr<tbox::Timer> ConvectiveFluxReconstructorWCNS_Test::t_WENO_interpolation_compute_interpolated_values;
boost::shared_ptr<tbox::Timer> ConvectiveFluxReconstructorWCNS_Test::t_WENO_interpolation_compute_alpha;
boost::shared_ptr<tbox::Timer> ConvectiveFluxReconstructorWCNS_Test::t_WENO_interpolation_compute_omega;

ConvectiveFluxReconstructorWCNS_Test::ConvectiveFluxReconstructorWCNS_Test(
        ...
        beta_tilde(4)
{
    ...
    d_constant_C          = d_shock_capturing_scheme_db->getDoubleWithDefault("constant_C", 1.0e10);
    d_constant_C          = d_shock_capturing_scheme_db->getDoubleWithDefault("d_constant_C", d_constant_C);
    
    d_constant_p          = d_shock_capturing_scheme_db->getIntegerWithDefault("constant_p", 2);
    d_constant_p          = d_shock_capturing_scheme_db->getIntegerWithDefault("d_constant_p", d_constant_p);
    ...
    d_constant_alpha_TV   = d_shock_capturing_scheme_db->getDoubleWithDefault("constant_alpha_TV", 5.0);
    d_constant_alpha_TV   = d_shock_capturing_scheme_db->getDoubleWithDefault("d_constant_alpha_TV", d_constant_alpha_TV);
    
    d_constant_alpha_beta = d_shock_capturing_scheme_db->getDoubleWithDefault("constant_alpha_beta", 1.5);
    d_constant_alpha_beta = d_shock_capturing_scheme_db->getDoubleWithDefault("d_constant_alpha_beta", d_constant_alpha_beta);
    ...
    t_compute_v_p_f = tbox::TimerManager::getManager()->
        getTimer("ConvectiveFluxReconstructorWCNS_Test::t_compute_v_p_f");
    
    t_compute_theta_omega = tbox::TimerManager::getManager()->
        getTimer("ConvectiveFluxReconstructorWCNS_Test::t_compute_theta_omega");
    
    t_compute_projection_matrices = tbox::TimerManager::getManager()->
        getTimer("ConvectiveFluxReconstructorWCNS_Test::t_compute_projection_matrices");
    
    t_compute_midpoint_fluxes = tbox::TimerManager::getManager()->
        getTimer("ConvectiveFluxReconstructorWCNS_Test::t_compute_midpoint_fluxes");
    
    t_compute_fluxes = tbox::TimerManager::getManager()->
        getTimer("ConvectiveFluxReconstructorWCNS_Test::t_compute_fluxes");
    
    t_projection = tbox::TimerManager::getManager()->
        getTimer("ConvectiveFluxReconstructorWCNS_Test::t_projection");
    
    t_WENO_interpolation = tbox::TimerManager::getManager()->
        getTimer("ConvectiveFluxReconstructorWCNS_Test::t_WENO_interpolation");
    
    t_Riemann_solver = tbox::TimerManager::getManager()->
        getTimer("ConvectiveFluxReconstructorWCNS_Test::t_Riemann_solver");
    
    t_WENO_interpolation_compute_sigma_TV = tbox::TimerManager::getManager()->
        getTimer("ConvectiveFluxReconstructorWCNS_Test::t_WENO_interpolation_compute_sigma_TV");
    
    t_WENO_interpolation_compute_beta = tbox::TimerManager::getManager()->
        getTimer("ConvectiveFluxReconstructorWCNS_Test::t_WENO_interpolation_compute_beta");
    
    t_WENO_interpolation_compute_interpolated_values = tbox::TimerManager::getManager()->
        getTimer("ConvectiveFluxReconstructorWCNS_Test::t_WENO_interpolation_compute_interpolated_values");
    
    t_WENO_interpolation_compute_alpha = tbox::TimerManager::getManager()->
        getTimer("ConvectiveFluxReconstructorWCNS_Test::t_WENO_interpolation_compute_alpha");
    
    t_WENO_interpolation_compute_omega = tbox::TimerManager::getManager()->
        getTimer("ConvectiveFluxReconstructorWCNS_Test::t_WENO_interpolation_compute_omega");
        
    t_miscellaneous = tbox::TimerManager::getManager()->
        getTimer("ConvectiveFluxReconstructorWCNS_Test::t_miscellaneous");
    
    t_allocate_memory = tbox::TimerManager::getManager()->
        getTimer("ConvectiveFluxReconstructorWCNS_Test::t_allocate_memory");
}
 ...
 */
void
ConvectiveFluxReconstructorWCNS_Test::printClassData(
    std::ostream& os) const
{
    os << "\nPrint ConvectiveFluxReconstructorWCNS_Test object..."
       << std::endl;
    
    os << std::endl;
    
    os << "ConvectiveFluxReconstructorWCNS_Test: this = "
       << (ConvectiveFluxReconstructorWCNS_Test *)this
       << std::endl;
    os << "d_object_name = "
       << d_object_name
       << std::endl;
 ...
 */
void
ConvectiveFluxReconstructorWCNS_Test::putToRestart(
 ...
 */
void
ConvectiveFluxReconstructorWCNS_Test::computeConvectiveFluxesAndSources(
    hier::Patch& patch,
    const double time,
    const double dt,
    ...
    const boost::shared_ptr<hier::VariableContext>& data_context)
{
    ...
    if (d_variables_set == true)
    {
        if (d_num_ghosts_set == true)
        {
            ...
            {
                /*
                 * Register the cell data in the flow model and compute the cell data.
                 */
                ...
                d_flow_model_handler->registerPatchWithGlobalCellData(
                    patch,
                    num_subghosts_of_data,
                    data_context);
                
                d_flow_model_handler->registerFaceProjectionMatricesOfPrimitiveVariables(
                    d_num_conv_ghosts,
                    SIMPLE_AVG);
                
                d_flow_model_handler->computeGlobalCellData();
                
                /*
                 * Get the pointers to the data inside the flow model.
                 */
                
                hier::IntVector num_subghosts_velocity(d_dim);
                hier::IntVector num_subghosts_convective_flux_x(d_dim);
                
                hier::IntVector subghostcell_dims_velocity(d_dim);
                hier::IntVector subghostcell_dims_convective_flux_x(d_dim);
                
                boost::shared_ptr<pdat::CellData<double> > velocity =
                    d_flow_model_handler->getGlobalCellData(
                        "VELOCITY",
                        num_subghosts_velocity,
                        subghostcell_dims_velocity);
                
                std::vector<boost::shared_ptr<pdat::CellData<double> > > convective_flux_node(1);
                convective_flux_node[0] =
                    d_flow_model_handler->getGlobalCellData(
                        "CONVECTIVE_FLUX_X",
                        num_subghosts_convective_flux_x,
                        subghostcell_dims_convective_flux_x);
                ...
                std::vector<double*> Q = d_flow_model_handler->
                    getGlobalCellDataPointerConservativeVariables(
                        num_subghosts_conservative_var,
                        subghostcell_dims_conservative_var);
                
                std::vector<double*> V = d_flow_model_handler->
                    getGlobalCellDataPointerPrimitiveVariables(
                        num_subghosts_primitive_var,
                        subghostcell_dims_primitive_var);
                
                double* u = velocity->getPointer(0);
                std::vector<double*> F_x_node(d_num_eqn);
                for (int ei = 0; ei < d_num_eqn; ei++)
                {
                    F_x_node[ei] = convective_flux_node[0]->getPointer(ei);
                }
                std::vector<double*> F_x_midpoint(d_num_eqn);
                for (int ei = 0; ei < d_num_eqn; ei++)
                {
                    F_x_midpoint[ei] = convective_flux_midpoint->getPointer(0, ei);
                }
                ...
                std::vector<boost::reference_wrapper<double> > u_x_midpoint_ref;
                u_x_midpoint_ref.reserve(d_num_eqn);
                ...
                for (int i = -1; i < interior_dims[0] + 2; i++)
                {
                    ...
                    if (!d_flow_model_handler->havePrimitiveVariablesBounded(V_x_L))
                    {
                        is_constant_interpolation = true;
                    }
                    
                    if (!d_flow_model_handler->havePrimitiveVariablesBounded(V_x_R))
                    {
                        is_constant_interpolation = true;
                    }
                ...
                const std::vector<EQUATION_FORM> eqn_form = d_flow_model_handler->getEquationsForm();
                ...
                /*
                 * Unregister all the cell data in the flow model.
                 */
                
                d_flow_model_handler->unregisterPatchWithGlobalCellData();
            ...
            else if (d_dim == tbox::Dimension(2))
            {
                ...
                hier::IntVector num_subghosts_velocity(d_dim);
                hier::IntVector num_subghosts_dilatation(d_dim);
                hier::IntVector num_subghosts_vorticity(d_dim);
                hier::IntVector num_subghosts_convective_flux_x(d_dim);
                hier::IntVector num_subghosts_convective_flux_y(d_dim);
                
                hier::IntVector subghostcell_dims_velocity(d_dim);
                hier::IntVector subghostcell_dims_dilatation(d_dim);
                hier::IntVector subghostcell_dims_vorticity(d_dim);
                hier::IntVector subghostcell_dims_convective_flux_x(d_dim);
                hier::IntVector subghostcell_dims_convective_flux_y(d_dim);
                ...
                boost::shared_ptr<pdat::CellData<double> > dilatation =
                    d_flow_model_handler->getGlobalCellData(
                        "DILATATION",
                        num_subghosts_dilatation,
                        subghostcell_dims_dilatation);
                
                boost::shared_ptr<pdat::CellData<double> > vorticity =
                    d_flow_model_handler->getGlobalCellData(
                        "VORTICITY",
                        num_subghosts_vorticity,
                        subghostcell_dims_vorticity);
                ...
                convective_flux_node[1] =
                    d_flow_model_handler->getGlobalCellData(
                        "CONVECTIVE_FLUX_Y",
                        num_subghosts_convective_flux_y,
                        subghostcell_dims_convective_flux_y);
                ...
                std::vector<double*> F_x_node(d_num_eqn);
                std::vector<double*> F_y_node(d_num_eqn);
                for (int ei = 0; ei < d_num_eqn; ei++)
                {
                    F_x_node[ei] = convective_flux_node[0]->getPointer(ei);
                    F_y_node[ei] = convective_flux_node[1]->getPointer(ei);
                }
                std::vector<double*> F_x_midpoint(d_num_eqn);
                std::vector<double*> F_y_midpoint(d_num_eqn);
                for (int ei = 0; ei < d_num_eqn; ei++)
                {
                    F_x_midpoint[ei] = convective_flux_midpoint->getPointer(0, ei);
                    F_y_midpoint[ei] = convective_flux_midpoint->getPointer(1, ei);
                }
                ...
                // Declare container to store the references to the mid-point velocity.
                std::vector<boost::reference_wrapper<double> > v_y_midpoint_ref;
                v_y_midpoint_ref.reserve(d_num_eqn);
                ...
                for (int i = 0; i < interior_dims[0]; i++)
                {
                    for (int j = -1; j < interior_dims[1] + 2; j++)
                    {
                        ...
                        // If the WENO interpolated values are out of bound, use constant interpolation.
                        if (!d_flow_model_handler->havePrimitiveVariablesBounded(V_y_B))
                        {
                            is_constant_interpolation = true;
                        }
                        
                        if (!d_flow_model_handler->havePrimitiveVariablesBounded(V_y_T))
                        {
                            is_constant_interpolation = true;
                        }
            ...
            else if (d_dim == tbox::Dimension(3))
            {
                ...
                hier::IntVector num_subghosts_convective_flux_x(d_dim);
                hier::IntVector num_subghosts_convective_flux_y(d_dim);
                hier::IntVector num_subghosts_convective_flux_z(d_dim);
                ...
                hier::IntVector subghostcell_dims_convective_flux_x(d_dim);
                hier::IntVector subghostcell_dims_convective_flux_y(d_dim);
                hier::IntVector subghostcell_dims_convective_flux_z(d_dim);
                ...
                convective_flux_node[2] =
                    d_flow_model_handler->getGlobalCellData(
                        "CONVECTIVE_FLUX_Z",
                        num_subghosts_convective_flux_z,
                        subghostcell_dims_convective_flux_z);
                ...
                std::vector<double*> F_x_node(d_num_eqn);
                std::vector<double*> F_y_node(d_num_eqn);
                std::vector<double*> F_z_node(d_num_eqn);
                for (int ei = 0; ei < d_num_eqn; ei++)
                {
                    F_x_node[ei] = convective_flux_node[0]->getPointer(ei);
                    F_y_node[ei] = convective_flux_node[1]->getPointer(ei);
                    F_z_node[ei] = convective_flux_node[2]->getPointer(ei);
                }
                std::vector<double*> F_x_midpoint(d_num_eqn);
                std::vector<double*> F_y_midpoint(d_num_eqn);
                std::vector<double*> F_z_midpoint(d_num_eqn);
                for (int ei = 0; ei < d_num_eqn; ei++)
                {
                    F_x_midpoint[ei] = convective_flux_midpoint->getPointer(0, ei);
                    F_y_midpoint[ei] = convective_flux_midpoint->getPointer(1, ei);
                    F_z_midpoint[ei] = convective_flux_midpoint->getPointer(2, ei);
                }
                ...
                // Declare container to store the references to the mid-point velocity.
                std::vector<boost::reference_wrapper<double> > w_z_midpoint_ref;
                w_z_midpoint_ref.reserve(d_num_eqn);
                ...
                for (int j = 0; j < interior_dims[1]; j++)
                {
                    for (int i = 0; i < interior_dims[0]; i++)
                    {
                        for (int k = -1; k < interior_dims[2] + 2; k++)
                        {
                            ...
                            // If the WENO interpolated values are out of bound, use constant interpolation.
                            if (!d_flow_model_handler->havePrimitiveVariablesBounded(V_z_B))
                            {
                                is_constant_interpolation = true;
                            }
                            
                            if (!d_flow_model_handler->havePrimitiveVariablesBounded(V_z_F))
                            {
                                is_constant_interpolation = true;
                            }
 ...
 */
void
ConvectiveFluxReconstructorWCNS_Test::projectPhysicalVariablesToCharacteristicFields(
 ...
 */
void
ConvectiveFluxReconstructorWCNS_Test::projectCharacteristicVariablesToPhysicalFields(
    std::vector<double>& U,
 ...
 */
void
ConvectiveFluxReconstructorWCNS_Test::computeSigmaAndTV(
    double& sigma,
 ...
 */
void
ConvectiveFluxReconstructorWCNS_Test::computeBeta(
 ...
 */
void
ConvectiveFluxReconstructorWCNS_Test::computeBetaTilde(
 ...
 */
void
ConvectiveFluxReconstructorWCNS_Test::performWENOInterpolation(
    ...
    const DIRECTION& direction)
{
    ...
    d_flow_model_handler->computeLocalFaceProjectionMatrixOfPrimitiveVariables(
        R_inv_intercell,
        cell_index_minus,
        cell_index_plus,
        direction);
    ...
    for (int ei = 0; ei < d_num_eqn; ei++)
    {
        ...
        const double tau_6 = fabs(beta[3] - 1.0/8*(beta[0] + beta[2] +
            6*beta[1]));
            ...
            (beta_ratio > alpha_beta))
        {
            ...
            d[0] = (2.0 - sigma_to_p)/32.0;
            d[1] = 5.0*(4.0 - sigma_to_p)/32.0;
            d[2] = 5.0*(2.0 + sigma_to_p)/32.0;
            d[3] = sigma_to_p/32.0;
            
            for (int r = 0; r < 4; r++)
            {
                // Compute the weights alpha.
                alpha[r] = d[r]*(EPSILON + sigma_to_p*C + pow(tau_6/(beta[r] + EPSILON), q));
        ...
        const double tau_6_tilde = fabs(beta_tilde[3] - 1.0/8*(beta_tilde[0] +
            beta_tilde[2] + 6*beta_tilde[1]));
            ...
            (beta_tilde_ratio > alpha_beta))
        {
            ...
            {
                // Compute the weights alpha_tilde.
                alpha_tilde[r] = d[r]*(EPSILON + sigma_to_p*C + pow(tau_6_tilde/(beta_tilde[r] + EPSILON), q));
    ...
    d_flow_model_handler->computeLocalFaceProjectionMatrixInverseOfPrimitiveVariables(
        R_intercell,
        cell_index_minus,
        cell_index_plus,
        direction);

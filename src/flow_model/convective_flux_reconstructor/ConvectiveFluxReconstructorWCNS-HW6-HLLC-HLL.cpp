...
ConvectiveFluxReconstructorWCNS_HW6_HLLC_HLL::ConvectiveFluxReconstructorWCNS_HW6_HLLC_HLL(
            ...
            d_equation_of_state)
{
    ...
    d_constant_C     = d_shock_capturing_scheme_db->getDoubleWithDefault("constant_C", 5.0);
    ...
    d_constant_delta = d_shock_capturing_scheme_db->getDoubleWithDefault("constant_delta",
 ...
 */
void
ConvectiveFluxReconstructorWCNS_HW6_HLLC_HLL::printClassData(
    std::ostream& os) const
{
    ...
    os << "ConvectiveFluxReconstructorWCNS_HW6_HLLC_HLL: this = "
       << (ConvectiveFluxReconstructorWCNS_HW6_HLLC_HLL *)this
       << std::endl;
    os << "d_object_name = "
       << d_object_name
       << std::endl;
    ...
    os << "End of ConvectiveFluxReconstructorWCNS_HW6_HLLC_HLL::printClassData"
       << std::endl;
}
 ...
 */
void
ConvectiveFluxReconstructorWCNS_HW6_HLLC_HLL::putToRestart(
 ...
 */
void
ConvectiveFluxReconstructorWCNS_HW6_HLLC_HLL::computeConvectiveFluxesAndSources(
    hier::Patch& patch,
    const double time,
    const double dt,
            ...
            case SINGLE_SPECIES:
            {
                ...
                if (d_dim == tbox::Dimension(1))
                {
                    ...
                    for (int i = -1; i < interior_dims[0] + 2; i++)
                    {
                        ...
                        /*
                         * If the WENO interpolated density or pressure are negative,
 ...
 */
void
ConvectiveFluxReconstructorWCNS_HW6_HLLC_HLL::projectPrimitiveVariablesToCharacteristicFields(
 ...
 */
void
ConvectiveFluxReconstructorWCNS_HW6_HLLC_HLL::projectCharacteristicVariablesToPhysicalFields(
 ...
 */
std::vector<double>
ConvectiveFluxReconstructorWCNS_HW6_HLLC_HLL::computeSigma(
    const boost::multi_array<double, 2>& W_array)
{
    ...
    for (int ei = 0; ei < d_num_eqn; ei++)
    {
        const double r_1 = (fabs(2*(W_array[2][ei] - W_array[1][ei])*(W_array[1][ei] - W_array[0][ei])) + delta)/
            (pow((W_array[2][ei] - W_array[1][ei]), 2) + pow((W_array[1][ei] - W_array[0][ei]), 2) + delta);
        
        const double r_2 = (fabs(2*(W_array[3][ei] - W_array[2][ei])*(W_array[2][ei] - W_array[1][ei])) + delta)/
            (pow((W_array[3][ei] - W_array[2][ei]), 2) + pow((W_array[2][ei] - W_array[1][ei]), 2) + delta);
        
        const double r_3 = (fabs(2*(W_array[4][ei] - W_array[3][ei])*(W_array[3][ei] - W_array[2][ei])) + delta)/
            (pow((W_array[4][ei] - W_array[3][ei]), 2) + pow((W_array[3][ei] - W_array[2][ei]), 2) + delta);
        
        const double r_4 = (fabs(2*(W_array[5][ei] - W_array[4][ei])*(W_array[4][ei] - W_array[3][ei])) + delta)/
            (pow((W_array[5][ei] - W_array[4][ei]), 2) + pow((W_array[4][ei] - W_array[3][ei]), 2) + delta);
...
ConvectiveFluxReconstructorWCNS_HW6_HLLC_HLL::computeBeta(
    const boost::multi_array<double, 2>& W_array)
{
#ifdef DEBUG_CHECK_ASSERTIONS
    TBOX_ASSERT(static_cast<int>(W_array.shape()[0]) == 6);
 ...
 */
boost::multi_array<double, 2>
ConvectiveFluxReconstructorWCNS_HW6_HLLC_HLL::computeBetaTilde(
    const boost::multi_array<double, 2>& W_array)
{
#ifdef DEBUG_CHECK_ASSERTIONS
    TBOX_ASSERT(static_cast<int>(W_array.shape()[0]) == 6);
 ...
 */
void
ConvectiveFluxReconstructorWCNS_HW6_HLLC_HLL::performWENOInterpolation(
    std::vector<double>& W_L,
    std::vector<double>& W_R,
    const boost::multi_array<double, 2>& W_array)
{
    ...
    for (int ei = 0; ei < d_num_eqn; ei++)
    {
        ...
        d[0] = (2.0 - sigma[ei])/32.0;
        d[1] = 5.0*(4.0 - sigma[ei])/32.0;
        d[2] = 5.0*(2.0 + sigma[ei])/32.0;
        d[3] = sigma[ei]/32.0;
        ...
        double tau_6 = beta[ei][3] - 1.0/8*(beta[ei][0] + beta[ei][2] +
            6*beta[ei][1]);
        ...
        double tau_6_tilde = beta_tilde[ei][3] - 1.0/8*(beta_tilde[ei][0] +
        ...
        for (int r = 0; r < 4; r++)
        {
            alpha_tilde.push_back(
                d[r]*(C + tau_6_tilde/(beta_tilde[ei][r] + EPSILON)));
        }

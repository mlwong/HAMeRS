...
ConvectiveFluxReconstructorTest::ConvectiveFluxReconstructorTest(
 ...
 */
void
ConvectiveFluxReconstructorTest::printClassData(
    std::ostream& os) const
{
    ...
    os << "ConvectiveFluxReconstructorTest: this = "
       << (ConvectiveFluxReconstructorTest *)this
       << std::endl;
    os << "d_object_name = "
       << d_object_name
       << std::endl;
    ...
    os << "End of ConvectiveFluxReconstructorTest::printClassData"
       << std::endl;
}
 ...
 */
void
ConvectiveFluxReconstructorTest::putToRestart(
 ...
 */
void
ConvectiveFluxReconstructorTest::computeConvectiveFluxAndSource(
    hier::Patch& patch,
    const double time,
    const double dt,
 ...
 */
void
ConvectiveFluxReconstructorTest::projectPrimitiveVariablesToCharacteristicFields(
 ...
 */
void
ConvectiveFluxReconstructorTest::projectCharacteristicVariablesToPhysicalFields(
 ...
 */
std::vector<double>
ConvectiveFluxReconstructorTest::computeSigma(
...
ConvectiveFluxReconstructorTest::computeBeta(
    const boost::multi_array<double, 2>& W_array)
{
#ifdef DEBUG_CHECK_ASSERTIONS
    TBOX_ASSERT(static_cast<int>(W_array.shape()[0]) == 6);
 ...
 */
boost::multi_array<double, 2>
ConvectiveFluxReconstructorTest::computeBetaTilde(
    const boost::multi_array<double, 2>& W_array)
{
#ifdef DEBUG_CHECK_ASSERTIONS
    TBOX_ASSERT(static_cast<int>(W_array.shape()[0]) == 6);
 ...
 */
void
ConvectiveFluxReconstructorTest::performWENOInterpolation(
    std::vector<double>& W_L,
    std::vector<double>& W_R,
    const boost::multi_array<double, 2>& W_array)
{
    ...
    for (int ei = 0; ei < d_num_eqn; ei++)
    {
        ...
        std::vector<double> d;
        d.push_back(1.0/32.0);
        d.push_back(15.0/32.0);
        d.push_back(15.0/32.0);
        d.push_back(1.0/32.0);
...
*/
        ...
        double tau_5 = fabs(beta[ei][0] - beta[ei][2]);
        
        if (tau_5 > fmin(fmin(fmin(beta[ei][0], beta[ei][1]), beta[ei][2]), beta[ei][3]))
        {
            for (int r = 0; r < 4; r++)
            {
                alpha.push_back(
        ...
        else
        {
            ...
            {
                alpha.push_back(
                    d[r]*(d_constant_D + pow(tau_6/(beta[ei][r] + EPSILON), d_constant_q)));
            }
        }
        ...
        double tau_5_tilde = fabs(beta_tilde[ei][0] - beta_tilde[ei][2]);
        
        if (tau_5_tilde > fmin(fmin(fmin(beta_tilde[ei][0], beta_tilde[ei][1]), beta_tilde[ei][2]), beta_tilde[ei][3]))
        {
            for (int r = 0; r < 4; r++)
            {
        ...
        else
        {
            ...
            {
                alpha_tilde.push_back(
                    d[r]*(d_constant_D + pow(tau_6_tilde/(beta_tilde[ei][r] + EPSILON), d_constant_q)));
            }
        }

...
ConvectiveFluxReconstructorWCNS_HW56_HLLC_HLL::ConvectiveFluxReconstructorWCNS_HW56_HLLC_HLL(
            ...
            d_equation_of_state)
{
    ...
    d_constant_D     = d_shock_capturing_scheme_db->getDoubleWithDefault("constant_D", 10000.0);
    d_constant_D     = d_shock_capturing_scheme_db->getDoubleWithDefault("d_constant_D", d_constant_D);
    
    d_constant_r_c   = d_shock_capturing_scheme_db->getDoubleWithDefault("constant_r_c", 0.5);
    d_constant_r_c   = d_shock_capturing_scheme_db->getDoubleWithDefault("d_constant_r_c", d_constant_r_c);
    
    d_constant_q     = d_shock_capturing_scheme_db->getDoubleWithDefault("constant_q", 2.0);
    d_constant_q     = d_shock_capturing_scheme_db->getDoubleWithDefault("d_constant_q", d_constant_q);
    
    d_constant_delta = d_shock_capturing_scheme_db->getDoubleWithDefault("constant_delta", 1.0e-3);
    d_constant_delta = d_shock_capturing_scheme_db->getDoubleWithDefault("d_constant_delta", d_constant_delta);
 ...
 */
void
ConvectiveFluxReconstructorWCNS_HW56_HLLC_HLL::printClassData(
    std::ostream& os) const
{
    ...
    os << "ConvectiveFluxReconstructorWCNS_HW56_HLLC_HLL: this = "
       << (ConvectiveFluxReconstructorWCNS_HW56_HLLC_HLL *)this
       << std::endl;
    os << "d_object_name = "
       << d_object_name
       << std::endl;
    ...
    os << "End of ConvectiveFluxReconstructorWCNS_HW56_HLLC_HLL::printClassData"
       << std::endl;
}
 ...
 */
void
ConvectiveFluxReconstructorWCNS_HW56_HLLC_HLL::putToRestart(
   const boost::shared_ptr<tbox::Database>& restart_db) const
{
    restart_db->putString("d_shock_capturing_scheme", "WCNS_HW56_HLLC_HLL");
    
    restart_db->putDouble("d_constant_D", d_constant_D);
    restart_db->putDouble("d_constant_r_c", d_constant_r_c);
    restart_db->putDouble("d_constant_q", d_constant_q);
 ...
 */
void
ConvectiveFluxReconstructorWCNS_HW56_HLLC_HLL::computeConvectiveFluxAndSource(
    hier::Patch& patch,
    const double time,
    const double dt,
 ...
 */
void
ConvectiveFluxReconstructorWCNS_HW56_HLLC_HLL::projectPrimitiveVariablesToCharacteristicFields(
 ...
 */
void
ConvectiveFluxReconstructorWCNS_HW56_HLLC_HLL::projectCharacteristicVariablesToPhysicalFields(
 ...
 */
std::vector<double>
ConvectiveFluxReconstructorWCNS_HW56_HLLC_HLL::computeSigma(
    const boost::multi_array<double, 2>& W_array)
{
    ...
    for (int ei = 0; ei < d_num_eqn; ei++)
    {
        const double r_1 = (fabs(2*(W_array[2][ei] - W_array[1][ei])*(W_array[1][ei] - W_array[0][ei])))/
            (pow((W_array[2][ei] - W_array[1][ei]), 2) + pow((W_array[1][ei] - W_array[0][ei]), 2) + d_constant_delta);
        
        const double r_2 = (fabs(2*(W_array[3][ei] - W_array[2][ei])*(W_array[2][ei] - W_array[1][ei])))/
            (pow((W_array[3][ei] - W_array[2][ei]), 2) + pow((W_array[2][ei] - W_array[1][ei]), 2) + d_constant_delta);
        
        const double r_3 = (fabs(2*(W_array[4][ei] - W_array[3][ei])*(W_array[3][ei] - W_array[2][ei])))/
            (pow((W_array[4][ei] - W_array[3][ei]), 2) + pow((W_array[3][ei] - W_array[2][ei]), 2) + d_constant_delta);
        
        const double r_4 = (fabs(2*(W_array[5][ei] - W_array[4][ei])*(W_array[4][ei] - W_array[3][ei])))/
            (pow((W_array[5][ei] - W_array[4][ei]), 2) + pow((W_array[4][ei] - W_array[3][ei]), 2) + d_constant_delta);
        
        sigma.push_back(fmin(1.0, fmin(fmin(r_1, r_2), fmin(r_3, r_4))/d_constant_r_c));
    }
...
ConvectiveFluxReconstructorWCNS_HW56_HLLC_HLL::computeBeta(
    const boost::multi_array<double, 2>& W_array)
{
#ifdef DEBUG_CHECK_ASSERTIONS
    TBOX_ASSERT(static_cast<int>(W_array.shape()[0]) == 6);
 ...
 */
boost::multi_array<double, 2>
ConvectiveFluxReconstructorWCNS_HW56_HLLC_HLL::computeBetaTilde(
    const boost::multi_array<double, 2>& W_array)
{
#ifdef DEBUG_CHECK_ASSERTIONS
    TBOX_ASSERT(static_cast<int>(W_array.shape()[0]) == 6);
 ...
 */
void
ConvectiveFluxReconstructorWCNS_HW56_HLLC_HLL::performWENOInterpolation(
    std::vector<double>& W_L,
    std::vector<double>& W_R,
    const boost::multi_array<double, 2>& W_array)
{
    ...
    for (int ei = 0; ei < d_num_eqn; ei++)
    {
        ...
        std::vector<double> d;
        d.push_back((2.0 - sigma[ei])/32.0);
        d.push_back(5.0*(4.0 - sigma[ei])/32.0);
        d.push_back(5.0*(2.0 + sigma[ei])/32.0);
        d.push_back(sigma[ei]/32.0);
        ...
        // Make sure that the last smoothness indicator is the largest.
        beta[ei][3] = fmax(fmax(fmax(beta[ei][0], beta[ei][1]), beta[ei][2]),
            beta[ei][3]);
        ...
        {
            alpha.push_back(
                d[r]*(EPSILON + sigma[ei]*d_constant_D + pow(tau_6/(beta[ei][r] + EPSILON), d_constant_q)));
        }
        ...
        // Make sure that the last smoothness indicator is the largest.
        beta_tilde[ei][3] = fmax(fmax(fmax(beta_tilde[ei][0], beta_tilde[ei][1]),
            beta_tilde[ei][2]), beta_tilde[ei][3]);
        ...
        for (int r = 0; r < 4; r++)
        {
            alpha_tilde.push_back(
                d[r]*(EPSILON + sigma[ei]*d_constant_D + pow(tau_6_tilde/(beta_tilde[ei][r] + EPSILON), d_constant_q)));
        }

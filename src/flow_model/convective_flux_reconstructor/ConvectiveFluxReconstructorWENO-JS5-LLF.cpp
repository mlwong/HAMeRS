            ...
            shock_capturing_scheme_db)
{
    ...
    d_weights_d.push_back(1.0/10);
    d_weights_d.push_back(3.0/5);
    d_weights_d.push_back(3.0/10);
    ...
    std::ostream& os) const
{
    ...
    os << "ConvectiveFluxReconstructorWENO_JS5_LLF: this = "
       << (ConvectiveFluxReconstructorWENO_JS5_LLF *)this
       << std::endl;
    os << "d_object_name = "
       << d_object_name
       << std::endl;
 ...
 */
void
ConvectiveFluxReconstructorWENO_JS5_LLF::putToRestart(
   const boost::shared_ptr<tbox::Database>& restart_db) const
{
    restart_db->putString("d_shock_capturing_scheme", "WENO_JS5_LLF");
}
 ...
 */
void
ConvectiveFluxReconstructorWENO_JS5_LLF::computeConvectiveFluxesAndSources(
    hier::Patch& patch,
    const double time,
    const double dt,
 ...
 */
void
ConvectiveFluxReconstructorWENO_JS5_LLF::projectVariablesToCharacteristicFields(
 ...
 */
void
ConvectiveFluxReconstructorWENO_JS5_LLF::projectCharacteristicVariablesToPhysicalFields(
...
ConvectiveFluxReconstructorWENO_JS5_LLF::computeBetaPlus(
 ...
 */
boost::multi_array<double, 2>
ConvectiveFluxReconstructorWENO_JS5_LLF::computeBetaMinus(
 ...
 */
void
ConvectiveFluxReconstructorWENO_JS5_LLF::performWENOReconstruction(
   ...
   const boost::multi_array<double, 2>& G_minus_array)
{
    ...
    for (int ei = 0; ei < d_num_eqn; ei++)
    {
        ...
        for (int r = 0; r < 3; r++)
        {
            alpha_plus.push_back(d_weights_d[r]/pow((beta_plus[ei][r] + EPSILON), 2));
        }
        ...
        for (int r = 0; r < 3; r++)
        {
            alpha_minus.push_back(d_weights_d[r]/pow((beta_minus[ei][r] + EPSILON), 2));
        }

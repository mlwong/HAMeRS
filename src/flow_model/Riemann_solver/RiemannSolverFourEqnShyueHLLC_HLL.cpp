#include "flow_model/Riemann_solver/RiemannSolverFourEqnShyueHLLC_HLL.hpp"

/*
 * Compute the flux and velocity at the intercell face from conservative variables.
 */
void
RiemannSolverFourEqnShyueHLLC_HLL::computeIntercellFluxAndVelocityFromConservativeVariables(
 ...
 */
void
RiemannSolverFourEqnShyueHLLC_HLL::computeIntercellFluxAndVelocityFromPrimitiveVariables(
    std::vector<boost::reference_wrapper<double> >& flux_intercell,
    std::vector<boost::reference_wrapper<double> >& velocity_intercell,
 ...
 */
void
RiemannSolverFourEqnShyueHLLC_HLL::computeIntercellFluxAndVelocityInXDirectionFromConservativeVariables(
 ...
 */
void
RiemannSolverFourEqnShyueHLLC_HLL::computeIntercellFluxAndVelocityInYDirectionFromConservativeVariables(
 ...
 */
void
RiemannSolverFourEqnShyueHLLC_HLL::computeIntercellFluxAndVelocityInZDirectionFromConservativeVariables(
 ...
 */
void
RiemannSolverFourEqnShyueHLLC_HLL::computeIntercellFluxAndVelocityInXDirectionFromPrimitiveVariables(
    std::vector<boost::reference_wrapper<double> >& F_x_intercell,
    std::vector<boost::reference_wrapper<double> >& vel_intercell,
 ...
 */
void
RiemannSolverFourEqnShyueHLLC_HLL::computeIntercellFluxAndVelocityInYDirectionFromPrimitiveVariables(
    std::vector<boost::reference_wrapper<double> >& F_y_intercell,
    std::vector<boost::reference_wrapper<double> >& vel_intercell,
 ...
 */
void
RiemannSolverFourEqnShyueHLLC_HLL::computeIntercellFluxAndVelocityInZDirectionFromPrimitiveVariables(
    std::vector<boost::reference_wrapper<double> >& F_z_intercell,
    std::vector<boost::reference_wrapper<double> >& vel_intercell,
    const std::vector<boost::reference_wrapper<double> >& V_B,

...
GradientSensorFirstDerivative::GradientSensorFirstDerivative(
 ...
 */
void
GradientSensorFirstDerivative::computeGradient(
    hier::Patch& patch,
 ...
 */
void
GradientSensorFirstDerivative::computeGradientWithVariableLocalMean(
    hier::Patch& patch,
    boost::shared_ptr<pdat::CellData<double> > cell_data,
    boost::shared_ptr<pdat::CellData<double> > gradient,
    boost::shared_ptr<pdat::CellData<double> > variable_local_mean,

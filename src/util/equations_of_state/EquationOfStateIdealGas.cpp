...
{
    /*
     * Get the assumption on thermal process.
     */
    
    std::string thermal_pro_assum_str;
    if (d_equation_of_state_db->keyExists("thermal_pro_assum"))
    {
        thermal_pro_assum_str = d_equation_of_state_db->getString("thermal_pro_assum");
    }
    else if (d_equation_of_state_db->keyExists("d_thermal_pro_assum"))
    {
        thermal_pro_assum_str = d_equation_of_state_db->getString("d_thermal_pro_assum");
    }
    else
    {
        TBOX_ERROR(d_object_name
            << ": "
            << "Key data 'thermal_pro_assum' or 'd_thermal_pro_assum' not found in data for Equation_of_state."
            << std::endl);
    }
    
    if (thermal_pro_assum_str == "ISOTHERMAL")
    {
        d_thermal_pro_assum = ISOTHERMAL;
    }
    else if (thermal_pro_assum_str == "ISOBARIC")
    {
        d_thermal_pro_assum = ISOBARIC;
    }
    else if (thermal_pro_assum_str == "NO_ASSUMPTION")
    {
        d_thermal_pro_assum = NO_ASSUMPTION;
    }
    else
    {
        TBOX_ERROR(d_object_name
            << ": "
            << "Unknown thermal_pro_assum/d_thermal_pro_assum string = '"
            << thermal_pro_assum_str
            << "' found in input/restart file."
            << std::endl);        
    }
    
    /*
     * Get the specific heat capacity at constant pressure of each species from the database.
     */
    ...
    else
    {
        TBOX_ERROR(d_object_name
            << ": "
            << "Key data 'species_Cp' or 'd_species_Cp' not found in data for Equation_of_state."
            << std::endl);
    }
    
    /*
     * Get the specific heat capacity at constant volume of each species from the database.
     */
    ...
    else
    {
        TBOX_ERROR(d_object_name
            << ": "
            << "Key data 'species_Cv' or 'd_species_Cv' not found in data for Equation_of_state."
            << std::endl);
    }
        
    /*
     * Compute the ratio of specific heat capacities of each species.
     */
    
    d_species_gamma.reserve(d_num_species);
    for (int si = 0; si < d_num_species; si++)
    {
        d_species_gamma.push_back(d_species_Cp[si]/d_species_Cv[si]);
    }
}
    ...
    std::ostream& os) const
{
    ...
    /*
     * Print the specific heat capacity at constant pressure of each species.
     */
    ...
    /*
     * Print the specific heat capacity at constant volume of each species.
     */
   ...
   const boost::shared_ptr<tbox::Database>& restart_db) const
{
    ...
    switch (d_thermal_pro_assum)
    {
        case ISOTHERMAL:
        {
            restart_db->putString("d_thermal_pro_assum", "ISOTHERMAL");
            
            break;
        }
        case ISOBARIC:
        {
            restart_db->putString("d_thermal_pro_assum", "ISOBARIC");
            
            break;
        }
        case NO_ASSUMPTION:
        {
            restart_db->putString("d_thermal_pro_assum", "NO_ASSUMPTION");

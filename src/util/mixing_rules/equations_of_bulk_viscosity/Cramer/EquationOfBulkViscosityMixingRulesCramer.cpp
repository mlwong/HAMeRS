            ...
            equation_of_bulk_viscosity_mixing_rules_db)
{
    ...
    if (equation_of_bulk_viscosity_mixing_rules_db->keyExists("species_gamma"))
    {
        ...
        {
            d_species_gamma =
                equation_of_bulk_viscosity_mixing_rules_db->getRealVector("species_gamma");
        }
        else
        {
    ...
    else if (equation_of_bulk_viscosity_mixing_rules_db->keyExists("d_species_gamma"))
    {
        ...
        {
            d_species_gamma =
                equation_of_bulk_viscosity_mixing_rules_db->getRealVector("d_species_gamma");
        }
        else
        {
            TBOX_ERROR(d_object_name
    ...
    if (equation_of_bulk_viscosity_mixing_rules_db->keyExists("species_A_r"))
    {
        ...
        {
            d_species_A_r =
                equation_of_bulk_viscosity_mixing_rules_db->getRealVector("species_A_r");
        }
        else
        {
            TBOX_ERROR(d_object_name
    ...
    else if (equation_of_bulk_viscosity_mixing_rules_db->keyExists("d_species_A_r"))
    {
        ...
        {
            d_species_A_r =
                equation_of_bulk_viscosity_mixing_rules_db->getRealVector("d_species_A_r");
        }
        else
        {
            TBOX_ERROR(d_object_name
    ...
    if (equation_of_bulk_viscosity_mixing_rules_db->keyExists("species_B_r"))
    {
        ...
        {
            d_species_B_r =
                equation_of_bulk_viscosity_mixing_rules_db->getRealVector("species_B_r");
        }
        else
        {
            TBOX_ERROR(d_object_name
    ...
    else if (equation_of_bulk_viscosity_mixing_rules_db->keyExists("d_species_B_r"))
    {
        ...
        {
            d_species_B_r =
                equation_of_bulk_viscosity_mixing_rules_db->getRealVector("d_species_B_r");
        }
        else
        {
            TBOX_ERROR(d_object_name
    ...
    if (equation_of_bulk_viscosity_mixing_rules_db->keyExists("species_c_v_v"))
    {
        ...
        {
            d_species_c_v_v =
                equation_of_bulk_viscosity_mixing_rules_db->getRealVector("species_c_v_v");
        }
        else
        {
            TBOX_ERROR(d_object_name
    ...
    else if (equation_of_bulk_viscosity_mixing_rules_db->keyExists("d_species_c_v_v"))
    {
        ...
        {
            d_species_c_v_v =
                equation_of_bulk_viscosity_mixing_rules_db->getRealVector("d_species_c_v_v");
        }
        else
        {
            TBOX_ERROR(d_object_name
    ...
    if (equation_of_bulk_viscosity_mixing_rules_db->keyExists("species_A_v"))
    {
        ...
        {
            d_species_A_v =
                equation_of_bulk_viscosity_mixing_rules_db->getRealVector("species_A_v");
        }
        else
        {
            TBOX_ERROR(d_object_name
    ...
    else if (equation_of_bulk_viscosity_mixing_rules_db->keyExists("d_species_A_v"))
    {
        ...
        {
            d_species_A_v =
                equation_of_bulk_viscosity_mixing_rules_db->getRealVector("d_species_A_v");
        }
        else
        {
            TBOX_ERROR(d_object_name
    ...
    if (equation_of_bulk_viscosity_mixing_rules_db->keyExists("species_B_v"))
    {
        ...
        {
            d_species_B_v =
                equation_of_bulk_viscosity_mixing_rules_db->getRealVector("species_B_v");
        }
        else
        {
            TBOX_ERROR(d_object_name
    ...
    else if (equation_of_bulk_viscosity_mixing_rules_db->keyExists("d_species_B_v"))
    {
        ...
        {
            d_species_B_v =
                equation_of_bulk_viscosity_mixing_rules_db->getRealVector("d_species_B_v");
        }
        else
        {
            TBOX_ERROR(d_object_name
    ...
    if (equation_of_bulk_viscosity_mixing_rules_db->keyExists("species_C_v"))
    {
        ...
        {
            d_species_C_v =
                equation_of_bulk_viscosity_mixing_rules_db->getRealVector("species_C_v");
        }
        else
        {
            TBOX_ERROR(d_object_name
    ...
    else if (equation_of_bulk_viscosity_mixing_rules_db->keyExists("d_species_C_v"))
    {
        ...
        {
            d_species_C_v =
                equation_of_bulk_viscosity_mixing_rules_db->getRealVector("d_species_C_v");
        }
        else
        {
            TBOX_ERROR(d_object_name
    ...
    const HAMERS_SHARED_PTR<tbox::Database>& restart_db) const
{
    ...
    restart_db->putRealVector("d_species_A_r", d_species_A_r);
    restart_db->putRealVector("d_species_B_r", d_species_B_r);
    
    restart_db->putRealVector("d_species_c_v_v", d_species_c_v_v);
    restart_db->putRealVector("d_species_A_v", d_species_A_v);
    restart_db->putRealVector("d_species_B_v", d_species_B_v);
    ...
    const std::vector<const Real*>& mass_fractions) const
{
    ...
    if (static_cast<int>(mass_fractions.size()) == d_num_species)
    {
        for (int si = 0; si < d_num_species; si++)
        {
            ...
            const Real weight = *(mass_fractions[si])/(std::sqrt(species_molecular_properties[7]));
    ...
    else if (static_cast<int>(mass_fractions.size()) == d_num_species - 1)
    {
        ...
        const Real weight = Y_last/(std::sqrt(species_molecular_properties[7]));
    ...
    if (data_mass_fractions->getDepth() == d_num_species)
    {
        ...
        if (d_dim == tbox::Dimension(1))
        {
            ...
            for (int si = 0; si < d_num_species; si++)
            {
                ...
                const Real factor = Real(1)/(std::sqrt(species_molecular_properties[7]));

    ...
    const int& idx)
{
    ...
    if (s_x_star > Real(0))
    {
        ...
        Q_x_LR[3] = V_x_L[0][idx]*(epsilon_x_L[idx] + Real(1)/Real(2)*(V_x_L[1][idx]*V_x_L[1][idx] +
    ...
    else
    {
        ...
        Q_x_LR[3] = V_x_R[0][idx]*(epsilon_x_R[idx] + Real(1)/Real(2)*(V_x_R[1][idx]*V_x_R[1][idx] +
    ...
    const int& idx)
{
    ...
    if (s_x_star > Real(0))
    {
        ...
        Q_x_LR[4] = V_x_L[0][idx]*(epsilon_x_L[idx] + Real(1)/Real(2)*(V_x_L[1][idx]*V_x_L[1][idx] +
    ...
    else
    {
        ...
        Q_x_LR[4] = V_x_R[0][idx]*(epsilon_x_R[idx] + Real(1)/Real(2)*(V_x_R[1][idx]*V_x_R[1][idx] +
    ...
    const int& idx)
{
    ...
    if (s_y_star > Real(0))
    {
        ...
        Q_y_BT[3] = V_y_B[0][idx]*(epsilon_y_B[idx] + Real(1)/Real(2)*(V_y_B[1][idx]*V_y_B[1][idx] +
    ...
    else
    {
        ...
        Q_y_BT[3] = V_y_T[0][idx]*(epsilon_y_T[idx] + Real(1)/Real(2)*(V_y_T[1][idx]*V_y_T[1][idx] +
    ...
    const int& idx)
{
    ...
    if (s_y_star > Real(0))
    {
        ...
        Q_y_BT[4] = V_y_B[0][idx]*(epsilon_y_B[idx] + Real(1)/Real(2)*(V_y_B[1][idx]*V_y_B[1][idx] +
    ...
    else
    {
        ...
        Q_y_BT[4] = V_y_T[0][idx]*(epsilon_y_T[idx] + Real(1)/Real(2)*(V_y_T[1][idx]*V_y_T[1][idx] +
    ...
    const int& idx)
{
    ...
    if (s_z_star > Real(0))
    {
        ...
        Q_z_BF[4] = V_z_B[0][idx]*(epsilon_z_B[idx] + Real(1)/Real(2)*(V_z_B[1][idx]*V_z_B[1][idx] +
    ...
    else
    {
        ...
        Q_z_BF[4] = V_z_F[0][idx]*(epsilon_z_F[idx] + Real(1)/Real(2)*(V_z_F[1][idx]*V_z_F[1][idx] +

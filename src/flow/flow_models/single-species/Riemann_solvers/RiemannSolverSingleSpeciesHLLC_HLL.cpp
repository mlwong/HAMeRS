    ...
    const std::vector<boost::reference_wrapper<double> >& V_R)
{
    ...
    if (d_dim == tbox::Dimension(1))
    {
        ...
        if (s_star > 0)
        {
            ...
            const double epsilon_L = d_equation_of_state->
                getInternalEnergy(
                    &(V_L[0].get()),
                    &(V_L[2].get()),
                    thermo_properties_ptr);
        ...
        else
        {
            ...
            const double epsilon_R = d_equation_of_state->
                getInternalEnergy(
                    &(V_R[0].get()),
                    &(V_R[2].get()),
                    thermo_properties_ptr);
    ...
    const std::vector<boost::reference_wrapper<double> >& V_T)
{
    ...
    else if (d_dim == tbox::Dimension(2))
    {
        ...
        if (s_star > 0)
        {
            ...
            const double epsilon_B = d_equation_of_state->
                getInternalEnergy(
                    &(V_B[0].get()),
                    &(V_B[3].get()),
                    thermo_properties_ptr);
            ...
            {
                const double epsilon_T = d_equation_of_state->
                    getInternalEnergy(
                        &(V_T[0].get()),
                        &(V_T[3].get()),
                        thermo_properties_ptr);
    ...
    const std::vector<boost::reference_wrapper<double> >& V_F)
{
    ...
    else if (d_dim == tbox::Dimension(3))
    {
        ...
        if (s_star > 0)
        {
            ...
            {
                const double epsilon_F = d_equation_of_state->
                    getInternalEnergy(
                        &(V_F[0].get()),
                        &(V_F[4].get()),
                        thermo_properties_ptr);

    ...
    d_equation_of_state_mixing_rules(equation_of_state_mixing_rules)
{
    if (d_has_source_terms)
    {
        ...
        if (d_has_gravity)
        {
            ...
            {
                TBOX_ERROR(d_object_name
                    << ": FlowModelSourceUtilitiesFourEqnConservative::FlowModelSourceUtilitiesSingleSpecies\n"
 ...
 */
void
FlowModelSourceUtilitiesFourEqnConservative::registerDerivedVariablesForSource(
...
void
FlowModelSourceUtilitiesFourEqnConservative::computeSourceOnPatch(

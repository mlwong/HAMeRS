...
FlowModelSourceUtilitiesFiveEqnAllaire::FlowModelSourceUtilitiesFiveEqnAllaire(
 ...
 */
void
FlowModelSourceUtilitiesFiveEqnAllaire::registerDerivedVariablesForSourceTerms(
 ...
 */
void
FlowModelSourceUtilitiesFiveEqnAllaire::registerDerivedVariablesForSourceTermsStableDt(
    const hier::IntVector& num_subghosts)
{
    if (d_has_source_terms)
    {
 ...
 */
void
FlowModelSourceUtilitiesFiveEqnAllaire::allocateMemoryForDerivedCellData()
{
    if (d_has_source_terms)
    {
        if (d_flow_model.expired())
 ...
 */
void
FlowModelSourceUtilitiesFiveEqnAllaire::clearCellData()
{
 ...
 */
void
FlowModelSourceUtilitiesFiveEqnAllaire::computeDerivedCellData()
{
    if (d_has_source_terms)
    {
        if (d_flow_model.expired())
 ...
 */
double
FlowModelSourceUtilitiesFiveEqnAllaire::getStableDtOnPatch()
{
    // Create empty box.
 ...
 */
void
FlowModelSourceUtilitiesFiveEqnAllaire::setNumberOfSubGhosts(
    const hier::IntVector& num_subghosts,
 ...
 */
void
FlowModelSourceUtilitiesFiveEqnAllaire::setDerivedCellVariableGhostBoxes()
{
    if (d_flow_model.expired())
    {
        TBOX_ERROR(d_object_name
 ...
 */
void
FlowModelSourceUtilitiesFiveEqnAllaire::computeCellDataOfGruneisenParameter()
{
    // Create empty box.
    const hier::Box empty_box(d_dim);

...
FlowModelSubgridScaleModelFiveEqnAllaire::FlowModelSubgridScaleModelFiveEqnAllaire(
...
FlowModelSubgridScaleModelFiveEqnAllaire::getDerivedVariablesToRegister() const
{
 ...
 */
void
FlowModelSubgridScaleModelFiveEqnAllaire::getDerivedVariablesForInterpolationToSideData(
 ...
 */
void
FlowModelSubgridScaleModelFiveEqnAllaire::getCellDataOfVariablesForSideDerivativeForSubgridScaleViscosity(
 ...
 */
void
FlowModelSubgridScaleModelFiveEqnAllaire::updateSideDataOfDiffusiveFluxDiffusivities(
    ...
    const hier::Patch& patch)
{
    ...
    double* mu    = var_data_for_diffusivities[0]->getPointer(side_normal, 0);
    // double* mu_v  = var_data_for_diffusivities[1]->getPointer(side_normal, 0);
    
    const double* const rho = var_data_for_diffusivities[5 + 0]->getPointer(side_normal, 0);
 ...
 */
void
FlowModelSubgridScaleModelFiveEqnAllaire::putToRestart(
 ...
 */
void
FlowModelSubgridScaleModelFiveEqnAllaire::updateSideDataOfDiffusiveFluxDiffusivitiesVreman(
    double* mu,

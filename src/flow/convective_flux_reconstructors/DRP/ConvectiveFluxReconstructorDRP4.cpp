    ...
    const int RK_step_number)
{
    ...
    {
        a_1 = double( 0.841570125482);
        a_2 = double(-0.244678631765);
        a_3 = double( 0.059463584768);
        a_4 = double(-0.007650904064);
    ...
    else
    {
        TBOX_ERROR("ConvectiveFluxReconstructorDRP4::computeConvectiveFluxAndSourceOnPatch:"
            " only 9-point stencil DRP scheme is implemented");
    }

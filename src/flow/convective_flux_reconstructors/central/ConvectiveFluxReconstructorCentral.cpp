    ...
    const int RK_step_number)
{
    ...
    if (d_order == 8)
    {
        a_n =  double(4)/double(5);
        b_n = -double(1)/double(5);
        c_n =  double(4)/double(105);
        d_n = -double(1)/double(280);
    ...
    {
        a_n =  double(5)/double(6);
        b_n = -double(5)/double(21);
        c_n =  double(5)/double(84);
        d_n = -double(5)/double(504);
        e_n =  double(1)/double(1260);
    ...
    {
        a_n =  double(6)/double(7);
        b_n = -double(15)/double(56);
        c_n =  double(5)/double(63);
        d_n = -double(1)/double(56);
        e_n =  double(3)/double(1155);
        f_n = -double(1)/double(5544);

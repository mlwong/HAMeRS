...
DiffusiveFluxReconstructorNodeSixthOrder::DiffusiveFluxReconstructorNodeSixthOrder(
 ...
 */
void
DiffusiveFluxReconstructorNodeSixthOrder::printClassData(
    std::ostream& os) const
{
    os << "\nPrint DiffusiveFluxReconstructorNodeSixthOrder object..."
       << std::endl;
    
    os << std::endl;
    
    os << "DiffusiveFluxReconstructorNodeSixthOrder: this = "
       << (DiffusiveFluxReconstructorNodeSixthOrder *)this
       << std::endl;
    os << "d_object_name = "
       << d_object_name
       << std::endl;
 ...
 */
void
DiffusiveFluxReconstructorNodeSixthOrder::putToRestart(
 ...
 */
void
DiffusiveFluxReconstructorNodeSixthOrder::computeFirstDerivativesInX(
    Real* dudx,
    const Real* const u,
 ...
 */
void
DiffusiveFluxReconstructorNodeSixthOrder::computeFirstDerivativesInY(
    Real* dudy,
    const Real* const u,
    const hier::IntVector& num_ghosts_derivative_node,
    const hier::IntVector& num_ghosts_data_node,
 ...
 */
void
DiffusiveFluxReconstructorNodeSixthOrder::computeFirstDerivativesInZ(
    Real* dudz,
    const Real* const u,
    const hier::IntVector& num_ghosts_derivative_node,
    const hier::IntVector& num_ghosts_data_node,
 ...
 */
void
DiffusiveFluxReconstructorNodeSixthOrder::reconstructFluxX(
    Real* F_face_x,
    ...
    const double& dt) const
{
    ...
    const Real a_r = a_n + b_n + c_n;
    const Real b_r = b_n + c_n;
    const Real c_r = c_n;
 ...
 */
void
DiffusiveFluxReconstructorNodeSixthOrder::reconstructFluxY(
    Real* F_face_y,
 ...
 */
void
DiffusiveFluxReconstructorNodeSixthOrder::reconstructFluxZ(
    Real* F_face_z,

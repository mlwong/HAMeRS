...
const std::string CellCornersVariableFillPattern::s_name_id =
    "CELL_CORNERS_FILL_PATTERN";
 ...
 *************************************************************************
 */
CellCornersVariableFillPattern::
CellCornersVariableFillPattern(
...
CellCornersVariableFillPattern::calculateOverlap(
...
CellCornersVariableFillPattern::getStencilWidth()
{
 ...
 */
const std::string&
CellCornersVariableFillPattern::getPatternName() const
{
    return s_name_id;
}
 ...
 */
void
CellCornersVariableFillPattern::computeStencilBoxes(
    SAMRAI::hier::BoxContainer& stencil_boxes,
    const SAMRAI::hier::Box& dst_box) const
{
    ...
    for (unsigned short i = 0; i < d_dim.getValue(); i++)
    {
        if (d_layer_width[i] > 0)
        {
            ...
            stencil_boxes.removeIntersections(low_box);
            ...
            stencil_boxes.removeIntersections(high_box);
        }
    }
}
 ...
 */
boost::shared_ptr<SAMRAI::hier::BoxOverlap>
CellCornersVariableFillPattern::computeFillBoxesOverlap(

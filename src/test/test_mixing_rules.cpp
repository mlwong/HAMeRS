...
int main(int argc, char *argv[])
{
    ...
    molecular_properties[0] = Real(1.81e-5); // mu_ref
    molecular_properties[1] = Real(288.15); // T_ref
    molecular_properties[2] = Real(0.75); // power
    ...
    if (std::abs(mu - Real(2.0941878722236513e-05)) < Real(1.0e-8))
    {

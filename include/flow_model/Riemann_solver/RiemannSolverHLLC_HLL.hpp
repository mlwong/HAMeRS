#ifndef RIEMANN_SOLVER_HLLC_HLL_HPP
#define RIEMANN_SOLVER_HLLC_HLL_HPP

#include "flow_model/Riemann_solver/RiemannSolver.hpp"

class RiemannSolverHLLC_HLL: public RiemannSolver
{
    public:
        RiemannSolverHLLC_HLL(
...
#endif /* RIEMANN_SOLVER_HLLC_HLL_HPP */

#ifndef CONVECTIVE_FLUX_RECONSTRUCTOR_WCNS_HW6_LD_HLLC_HLL_HPP
#define CONVECTIVE_FLUX_RECONSTRUCTOR_WCNS_HW6_LD_HLLC_HLL_HPP
...
class ConvectiveFluxReconstructorWCNS_HW6_LD_HLLC_HLL: public ConvectiveFluxReconstructor
{
    public:
        ConvectiveFluxReconstructorWCNS_HW6_LD_HLLC_HLL(

#ifndef DIFFUSIVE_FLUX_RECONSTRUCTOR_NODE_FOURTH_ORDER_HPP
#define DIFFUSIVE_FLUX_RECONSTRUCTOR_NODE_FOURTH_ORDER_HPP

#include "flow/diffusive_flux_reconstructors/node/DiffusiveFluxReconstructorNode.hpp"

class DiffusiveFluxReconstructorNodeFourthOrder: public DiffusiveFluxReconstructorNode
{
    public:
        DiffusiveFluxReconstructorNodeFourthOrder(
...
#endif /* DIFFUSIVE_FLUX_RECONSTRUCTOR_NODE_FOURTH_ORDER_HPP */

#ifndef RIEMANN_SOLVER_FOUR_EQN_CONSERVATIVE_HLLC_HLL_HPP
#define RIEMANN_SOLVER_FOUR_EQN_CONSERVATIVE_HLLC_HLL_HPP

#include "flow/flow_models/four-eqn_conservative/Riemann_solvers/RiemannSolverFourEqnConservative.hpp"

using namespace SAMRAI;

class RiemannSolverFourEqnConservativeHLLC_HLL: public RiemannSolverFourEqnConservative
{
    public:
...
#endif /* RIEMANN_SOLVER_FOUR_EQN_CONSERVATIVE_HLLC_HLL_HPP */

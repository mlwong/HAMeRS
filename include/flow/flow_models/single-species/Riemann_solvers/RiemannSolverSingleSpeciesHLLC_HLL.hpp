#ifndef RIEMANN_SOLVER_SINGLE_SPECIES_HLLC_HLL_HPP
#define RIEMANN_SOLVER_SINGLE_SPECIES_HLLC_HLL_HPP

#include "flow/flow_models/single-species/Riemann_solvers/RiemannSolverSingleSpecies.hpp"

using namespace SAMRAI;

class RiemannSolverSingleSpeciesHLLC_HLL: public RiemannSolverSingleSpecies
{
    public:
...
#endif /* RIEMANN_SOLVER_SINGLE_SPECIES_HLLC_HLL_HPP */

#ifndef LAYER_CELL_NO_CORNERS_VARIABLE_FILL_PATTERN
#define LAYER_CELL_NO_CORNERS_VARIABLE_FILL_PATTERN
...
/*!
 * @brief Class LayerCellNoCornersVariableFillPattern is a concrete implementation of the abstract
 * base class VariableFillPattern.
 *
 * It is used to calculate overlaps according to a pattern which limits the overlaps to the
 * cell-centered ghost region of a distance away from patch, excluding all edges and corners.
 */

class LayerCellNoCornersVariableFillPattern:
    public SAMRAI::xfer::VariableFillPattern
{
    public:
         ...
         */
        explicit LayerCellNoCornersVariableFillPattern(
         ...
         * @brief Destructor
         */
        virtual ~LayerCellNoCornersVariableFillPattern();
         ...
         * region at a distance away from the patch, excluding all edges and corners.  The patch is
    ...
    private:
         ...
         * d_layer_offset away from dst_box, excluding any edges or corners.
         *
...
#endif /* LAYER_CELL_NO_CORNERS_VARIABLE_FILL_PATTERN */

#ifndef EULER_SPECIAL_BOUNDARY_CONDITIONS_HPP
#define EULER_SPECIAL_BOUNDARY_CONDITIONS_HPP
...
class EulerSpecialBoundaryConditions
{
    public:
        EulerSpecialBoundaryConditions(
...
#endif /* EULER_SPECIAL_BOUNDARY_CONDITIONS_HPP */

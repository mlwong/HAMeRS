#ifndef NAVIER_STOKES_ERROR_STATISTICS_HPP
#define NAVIER_STOKES_ERROR_STATISTICS_HPP
...
class NavierStokesErrorStatistics
{
    public:
        NavierStokesErrorStatistics(
...
#endif /* NAVIER_STOKES_ERROR_STATISTICS_HPP */

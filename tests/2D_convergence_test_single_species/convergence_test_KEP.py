...
convective_flux_schemes = [
    "KEP_CENTRAL2", "KEP_CENTRAL4", "KEP_CENTRAL6", "KEP_CENTRAL8", "KEP_CENTRAL10", "KEP_CENTRAL12", \
    "KEP_DRP_9PT", "KEP_DRP_11PT", "KEP_DRP_13PT"]

L2_convergence_rates_schemes_expected = [
    1.8, 3.8, 5.8, 7.7, 9.1, 11.0, \
    3.8, 3.8, 3.8]
...
for scheme in convective_flux_schemes:
    ...
    if scheme.find("KEP_CENTRAL") != -1:
        use_DRP4 = "FALSE"

        order = int(scheme.split("KEP_CENTRAL")[1])
    ...
    if scheme.find("KEP_DRP") != -1:
        use_DRP4 = "TRUE"

        stencil_width_str = scheme.split("_")[2]

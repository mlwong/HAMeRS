        ...
        for (int j = 0; j < patch_dims[1]; j++)
        {
            for (int i = 0; i < patch_dims[0]; i++)
            {
                ...
                if (x[0] >= d_special_source_box_hi[0])
                {
                    ...
                    const Real erf_offset_hi = half * erf((d_special_source_box_hi[0]-erf_start_hi)/(D*half)) + Real(0.5);   // value of erf at start of sponge
                ...
                if (x[1] >= d_special_source_box_hi[1])
                {
                    ...
                    const Real erf_offset_hi = half * erf((d_special_source_box_hi[1]-erf_start_hi)/(D*Real(0.5))) + half;   // value of erf at start of sponge

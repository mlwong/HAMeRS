    ...
    const hier::IntVector& ghost_width_to_fill)
{
    ...
    TBOX_ASSERT(d_special_boundary_conditions_db->keyExists("eta_const"));
    TBOX_ASSERT(d_special_boundary_conditions_db->keyExists("delta_const"));
    ...
    if (d_project_name == "2D smooth Isentropic Rayleigh-Taylor instability")
    {
        ...
        const double T_0 = 300.0; // interface temperature
        ...
        const double eta_0  = d_special_boundary_conditions_db->getDouble("eta_const");   // height of perturbation
        const double delta  = d_special_boundary_conditions_db->getDouble("delta_const"); // characteristic length of interface.
